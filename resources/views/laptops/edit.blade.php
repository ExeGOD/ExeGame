                    ...
                    <div class="card-body">
                        <form action="{{ route('laptops.update', $laptop->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('harga') is-invalid @enderror" name="harga" value="{{ old('harga', $laptop->harga) }}" placeholder="Masukkan Harga Produk">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" rows="5" placeholder="Masukkan Deskripsi">{{ old('deskripsi', $laptop->deskripsi) }}</textarea>
