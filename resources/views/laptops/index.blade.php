            ...
            <div class="col-md-12">
                <div>
                    <h1 class="text-center my-4" style="font-weight: bolder"><a href="/"
                            style="color: #47b5ff; text-decoration: none;" title="Ke halaman Home">ExeShop</a></h1>
                    <hr>
                </div>
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <h4 class="text-center my-2">DATA GAME</h4>
                                ...
                                @forelse ($laptops as $laptop)
                                    <tr>
                                        <td class="text-center">
                                            <img src="{{ asset('/storage/laptops/' . $laptop->image) }}" class="rounded"
                                                style="width: 150px">
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                action="{{ route('laptops.destroy', $laptop->id) }}" method="POST">
